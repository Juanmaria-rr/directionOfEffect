...
# the following package will be needed to read .xls files
...
print('preparing dataset for therapeutic areas')
...
#columns_to_pivot_on = ['actionType2', 'biosampleName', 'projectId', 'rightStudyType','colocalisationMethod','taLabel']
columns_to_pivot_on = ['taLabel']
...
df_annot.toPandas().to_csv(
    f"gs://ot-team/jroldan/analysis/{today_date}_credibleSetColocDoEanalysis_filteredColocAndCaviarWithOthers4phaseTherapeuticAreas.csv"
)
